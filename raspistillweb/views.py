...
RASPISTILL_DIRECTORY = '/home/pi/media/pictures/' 
THUMBNAIL_DIRECTORY = '/home/pi/media/thumbnails/' 
TIMELAPSE_DIRECTORY = '/home/pi/media/time-lapse/' 
...
SHA_OPTION_ALERT = 'Please enter a valid Sharpness option.'
...
# not implemented yet
image_quality = '100'
#image_sharpness = '0' #implemented by gnt 20/07/2015
image_contrast = '0'
image_brightness = '50'
image_saturation = '0'
...
def settings_view(request):
    ...
    return {'project' : 'raspistillWeb',
            ...
            'image_sha' : app_settings.image_SHA,
                                     
            'iso_options' :  ISO_OPTIONS, 
            'sha_options' :  SHA_OPTIONS, 
...
def photo_view(request):
    if timelapse:
        ...
        filedata['sha']=app_settings.image_SHA
...
def save_view(request):
    ...
    image_SHA_temp = request.params['shaOption']
    ...
    if image_SHA_temp and image_SHA_temp in SHA_OPTIONS:
        app_settings.image_SHA = image_SHA_temp
    else:
        preferences_fail_alert.append(SHA_OPTION_ALERT)        
...
def take_timelapse(filename):
    ...
    call (
        ...
        + ' -ifx ' + app_settings.image_effect
        + ' -th ' + THUMBNAIL_SIZE
        + ' -tl ' + str(app_settings.timelapse_interval*1000)
        + ' -t ' + str(app_settings.timelapse_time*1000*60) 
        + ' -sh ' + str(app_settings.image_SHA)
